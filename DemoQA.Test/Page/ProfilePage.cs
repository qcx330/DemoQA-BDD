...
namespace DemoQA.Test.Page
{
    public class ProfilePage :BasePage
    {
        ...
        public Element _btnDelete(string bookTitle) => new Element(By.XPath($"//a[text()='{bookTitle}']/ancestor::div[@role='row']//span[contains(@id,'delete')]"));
        ...
        public void VerifyBookRemoved(string title)
        {
        ...
        public void WaitForNavigateProfilePage(){
            WebDriverWait wait = new WebDriverWait(DriverManager.WebDriver, TimeSpan.FromSeconds(10));
        ...
        public void ClickOnDeleteButton(string title){
            _btnDelete(title).ClickOnElement();
        }
        public void VerifyBookAdd(string title){
            GoToUrl(UrlConstant.ProfileUrl);
            // SearchBook(title);
            // Assert.That(GetBook(title), Is.Not.Null);}
        }
    }
}